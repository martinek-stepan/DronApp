 ...
 */
public class MainContent extends ConstraintLayout implements DJIBaseProduct.DJIVersionCallback {
    ...
    private void initUI() {
            ...
            public void handleMessage(Message msg){
                switch(msg.what){
                    ...
                    if(connector != null){
                        ...
                        Log.d("annoying","Fetch Connector failed, reboot if you want to connect the Bluetooth");
                        return;
        ...
        mBtnOpen.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (Utils.isFastDoubleClick()) return;
                 // EventBus.getDefault().post(new SetViewWrapper(R.layout.zz_content_component_list, R.string.activity_component_list, getContext()));

                // instead of running examples start another activity
                Intent intent = new Intent(getContext(),VrtulnicekActivity.class);
        ...
        mBtnBluetooth.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(Utils.isFastDoubleClick()) return;
                EventBus.getDefault().post(new SetViewWrapper(R.layout.zz_content_bluetooth, R.string.component_listview_bluetooth,getContext()));
    ...
    public void onProductVersionChange(String oldVersion, String newVersion) {
        ...
        // commented out since this can crash application when run from another thread
    }
    ...
    private void refreshSDKRelativeUI() {
        ...
        if (null != mProduct && mProduct.isConnected()) {
            ...
            mTextProduct.setText("Test mode only");
